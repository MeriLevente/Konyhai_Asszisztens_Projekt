...
<template>
    ...
    <div class="form-floating mb-3">
        <select name="types" id="types" class="form-control" v-model="selectedTypeId" v-on:change="selectedItem = null; itemQuantity = null">
    ...
    <div class="row mt-4">
        <div class="col-8">
            <div class="row">
                <div class="col-10">
                    <div class="form-floating mb-2">
                        <input type="number" min="1" max="10000" class="form-control" v-model="itemQuantity" v-bind:disabled="!selectedItem"/>
            ...
            <div class="d-flex justify-content-center">
                <button class="btn btn-success me-3">{{ t("save") }}</button>
