...
<template>
    <div class="row d-flex justify-content-center">
        <div class="col-4 col-sm-5 d-flex justify-content-end">
            <button v-on:click="goBack" :disabled="paginatorFrom == 0 || paginatorLastElementDeleted">
                <i class="bi bi-arrow-left"></i>
            </button>
        </div>
        <div class="col-4 col-sm-1">
            <select v-model="paginatorValue" class="w-100"
                v-on:change="paginatorValueChanged">
        ...
        <div class="col-4 col-sm-5 d-flex justify-content-start">
            <button v-on:click="goForward"
                :disabled="maxLength - paginatorFrom <= paginatorValue">
