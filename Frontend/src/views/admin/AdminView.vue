...
<template>
    <main class="container my-5">
        ...
        <div class="row row-content my-5 d-flex justify-content-center">
            ...
            <div class="col-11 col-sm-5 p-2 m-1" v-on:click="navigateToPage('/edit-recipes')" 
                :class="windowWidth > 575 ? 'admin-box-white' : 'admin-box-blue'">
            ...
            <div class="col-11 col-sm-5 p-2 admin-box-blue m-1" v-on:click="navigateToPage('/register-admin')" 
                :class="windowWidth > 575 ? 'admin-box-blue' : 'admin-box-white'">
...
<style lang="css" scoped src="@/assets/css/admin.css"/>